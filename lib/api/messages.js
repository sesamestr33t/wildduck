...
module.exports = (db, server, messageHandler, userHandler, storageHandler, settingsHandler) => {
    ...
    server.get(
        ...
        tools.responseWrapper(async (req, res) => {
            ...
            // For $text searches, run count in parallel with the search — it may
            // finish in time for small mailboxes, and times out gracefully for large ones
            let totalPromise;
            if (isTextSearch) {
            ...
            let total = isTextSearch ? null : await getFilteredMessageCount(filter);
            ...
            let opts = {
                ...
                fields: {
                    ...
                    maxTimeMS: isTextSearch ? consts.DB_MAX_TIME_MESSAGES : consts.DB_MAX_TIME_MESSAGES_SEARCH
                },
